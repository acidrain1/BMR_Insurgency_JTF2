...
_tasktopicW = "Destroy High Voltage Tower";
_taskdescW = "Cut area power to give you tactical advantage by destroying high voltage tower with satchel or charge";
[_tskW,_tasktopicW,_taskdescW,WEST,[],"created",_towerPos] call SHK_Taskmaster_add;
sleep 5;

// create east task
_tskE = "tskE_Cut_Power" + _rnum;
_tasktopicE = "Protect High Voltage Tower";
_taskdescE =  "Protect high voltage tower to keep the lights on in the area";
...
[] spawn {
	...
	["City is loosing power within 1000 meter radius. Good Job!", "JIG_MPhint_fnc"] call BIS_fnc_mp;
