...
_tasktopicW = "Clear mine field";
_taskdescW =  "Clear mine field of enemys and deactivate or detonate all mines in minefield";
[_tskW,_tasktopicW,_taskdescW,WEST,[],"created",_newZone] call SHK_Taskmaster_add;
sleep 5;

// create east task
_tskE = "tskE_Mine_Field" + _rnum;
_tasktopicE = "Defend mine field";
_taskdescE =  "Eliminate any West unit in mine field";
