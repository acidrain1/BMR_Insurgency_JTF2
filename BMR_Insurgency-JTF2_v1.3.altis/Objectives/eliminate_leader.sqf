...
sleep 2;
private ["_newZone","_type","_rnum","_objmkr","_bunker","_VarName","_grp","_handle","_obj_leader","_stat_grp","_wp","_tskW","_tasktopicW","_taskdescW","_tskE","_tasktopicE","_taskdescE"];
...
_tasktopicW = "Eliminate Insurgent Leader";
_taskdescW = "Eliminate Insurgent Leader";
[_tskW,_tasktopicW,_taskdescW,WEST,[],"created",_newZone] call SHK_Taskmaster_add;
sleep 5;

// create east task
_tskE = "tskE_eliminate_leader" + _rnum;
_tasktopicE = "Defend Insurgent Leader";
_taskdescE = "Defend Insurgent Leader";
