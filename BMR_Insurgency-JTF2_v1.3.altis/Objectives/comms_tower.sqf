...
_tasktopicW = "Destroy Comms Tower";
_taskdescW =  "Destroy communications tower with satchel or charge";
[_tskW,_tasktopicW,_taskdescW,WEST,[],"created",_newZone] call SHK_Taskmaster_add;
sleep 5;

// create east task
_tskE = "tskE_Radio_Tower" + _rnum;
_tasktopicE = "Defend Comms Tower";
_taskdescE =  "Defend communications tower";
