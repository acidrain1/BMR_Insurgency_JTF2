...
switch (_faction) do {
	...
	_CHPool=	["I_Heli_Transport_02_F","I_Heli_light_03_unarmed_F","O_Heli_Transport_04_covered_F","O_Heli_Transport_04_bench_F"];
    ...
    _ACHPool= 	[];
	_CHPool= 	["O_Heli_Light_02_F","I_Heli_Transport_02_F","O_Heli_Transport_04_covered_F","O_Heli_Transport_04_bench_F"];
	_uavPool= 	[];
	...
	case 5 : {// Middle Eastern Conflict - SYRIAN ARAB ARMY
	_InfPool=	["MEC_SAA_Rifleman","MEC_SAA_SquadLeader","MEC_SAA_MachineGunner","MEC_SAA_AutomaticRifleman","MEC_SAA_Grenadier","MEC_SAA_ATSoldier","MEC_SAA_RPG7Soldier","MEC_SAA_AASoldier","MEC_SAA_Medic","MEC_SAA_Marksman","MEC_SAA_Crewman","MEC_SAA_Repair","MEC_SAA_Engineer","MEC_SAA_Explosives","MEC_SAA_Officer"];//"MEC_SAA_RPG7Grenadier",
	_ArmPool=	["MEC_SAA_T72","MEC_SAA_BMP1","MEC_SAA_BMP2","MEC_SAA_T55","MEC_SAA_ZSU23"];
	_MotPool=	["MEC_SAA_Offroad_01","MEC_SAA_Offroad_01_armed"];
	_ACHPool=	["O_Heli_Attack_02_black_F","O_Heli_Attack_02_F","MEC_SAA_Hind"];
	_CHPool=	["MEC_SAA_Hind","O_Heli_Light_02_F","O_Heli_Light_02_unarmed_F","O_Heli_Transport_04_covered_F","O_Heli_Transport_04_bench_F"];
	_uavPool=	[];
	_stPool=	["MEC_SAA_ZU23","MEC_SAA_DSHKM","MEC_SAA_DSHkM_Mini_TriPod","MEC_SAA_KORD","MEC_SAA_KORD_high","MEC_SAA_AGS","MEC_SAA_Metis","MEC_SAA_SPG9","MEC_SAA_Igla_AA_pod","MEC_SAA_2b14_82mm","MEC_SAA_D30","MEC_SAA_D30_AT"];
	_shipPool=	["O_Boat_Armed_01_hmg_F","O_Boat_Transport_01_F"];
	_diverPool=	["MEC_SAA_Engineer"];
	_crewPool=	["MEC_SAA_Crewman"];
	_heliCrew=	["MEC_SAA_Rifleman","MEC_SAA_MachineGunner","MEC_SAA_RPG7Soldier","MEC_SAA_AASoldier","MEC_SAA_Grenadier"];
};
	case 6 : {// Middle Eastern Conflict - Quds Force
	_InfPool=	["MEC_QUD_Rifleman","MEC_QUD_SquadLeader","MEC_QUD_MachineGunner","MEC_QUD_AutomaticRifleman","MEC_QUD_Grenadier","MEC_QUD_ATSoldier","MEC_QUD_AASoldier","MEC_QUD_Medic","MEC_QUD_Marksman","MEC_QUD_Crewman","MEC_QUD_Repair","MEC_QUD_Engineer","MEC_QUD_Explosives","MEC_QUD_Officer","MEC_QUD_Breacher"];//"MEC_QUD_RPG7Grenadier",
	_ArmPool=	["MEC_GME_T72","MEC_GME_BMP1","MEC_GME_BMP2","MEC_GME_ZSU23","MEC_GME_T55"];
	_MotPool=	["MEC_QUD_Offroad_01","MEC_QUD_Offroad_01_armed"];
	_ACHPool=	["O_Heli_Attack_02_black_F","O_Heli_Attack_02_F"];
	_CHPool=	["MEC_SAA_Hind","O_Heli_Light_02_F","O_Heli_Light_02_unarmed_F","O_Heli_Transport_04_covered_F","O_Heli_Transport_04_bench_F"];
	_uavPool=	[];
	_stPool=	["MEC_IRR_ZU23","MEC_IRR_DSHKM","MEC_IRR_DSHkM_Mini_TriPod","MEC_IRR_KORD","MEC_IRR_KORD_high","MEC_IRR_AGS","MEC_IRR_Metis","MEC_IRR_SPG9","MEC_IRR_Igla_AA_pod","MEC_IRR_2b14_82mm","MEC_IRR_D30","MEC_IRR_D30_AT"];
	_shipPool=	["O_Boat_Armed_01_hmg_F","O_Boat_Transport_01_F"];
	_diverPool=	["MEC_QUD_Engineer"];
	_crewPool=	["MEC_QUD_Crewman","MEC_QUD_SquadLeader","MEC_QUD_Grenadier","MEC_QUD_Engineer"];
	_heliCrew=	["MEC_QUD_MachineGunner","MEC_QUD_Grenadier","MEC_QUD_ATSoldier","MEC_QUD_AASoldier"];
};
	...
	_ACHPool=	["O_Heli_Attack_02_black_F","O_Heli_Attack_02_F","MEC_SAA_Hind"];
	_CHPool=	["O_Heli_Light_02_F","O_Heli_Light_02_unarmed_F","O_Heli_Transport_04_covered_F","O_Heli_Transport_04_bench_F","MEC_SAA_Hind"];
	_uavPool=	[];
	...
	_ACHPool=	["O_Heli_Attack_02_black_F","O_Heli_Attack_02_F"];
	_CHPool=	["O_Heli_Light_02_F","O_Heli_Attack_02_black_F"];
	_uavPool=	[];
	...
	_ArmPool=	["rhs_sprut_vdv","rhs_bmp1p_msv","rhs_brm1k_msv","rhs_bmp2_msv","rhs_bmp2e_msv","rhs_bmp2d_msv","rhs_bmp2k_msv","rhs_prp3_msv","rhs_bmd4_vdv","rhs_bmd4ma_vdv","rhs_t80u","rhs_t80bv","rhs_t80a","rhs_t72bc_tv","rhs_t72bb_tv","rhs_zsu234_aa"];
