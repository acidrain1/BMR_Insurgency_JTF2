...
while {true} do
{
	...
	//_animals = {_x isKindOf "Animal"} count _myentities;//A2
	...
	diag_log format ["Dead men=%1 Animals=%2", count alldeadmen, _animals];//A3
	diag_log format ["Groups=%1", _totalgrps];
	//diag_log format ["Dead units=%1 Groups=%2 Animals=%3", count allDead, count allGroups, _animals];//A2
	...
	{	
		...
		player groupchat format ["Dead men=%1 Groups=%2 Animals=%3", count alldeadmen, count allGroups, _animals];//A3
		//player groupchat format ["Dead units=%1 Groups=%2 Animals=%3", count allDead, count allGroups, _animals];//A2
