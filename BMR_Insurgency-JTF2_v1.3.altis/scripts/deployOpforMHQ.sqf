...
//Opfor_MHQ addAction [("<t color=""#12F905"">") + ("Deploy MHQ") + "</t>","scripts\deployOpforMHQ.sqf",nil,1, false, true];
...
if (vehicle _caller != player) exitWith {hint "Exit vehicle to deploy MHQ."};
...
if (_newPosAmmo isEqualTo []) exitWith {hint "Move MHQ to clearer area";};
