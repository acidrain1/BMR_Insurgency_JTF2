...
if (isServer) then {
	...
	objective_list = ["comms_tower","kill_leader","rescue_pilot","cut_power","mine_field","deliver_supplies","destroy_convoy","destroy_armed_convoy","destroy_mortar_squad","c_n_h"];publicVariable "objective_list";// all objectives (do not change array index order!)
...
{
	INS_Op4_side = EAST;	
	INS_men_list = ["MEC_SAA_Rifleman","MEC_SAA_SquadLeader","MEC_SAA_MachineGunner","MEC_SAA_AutomaticRifleman","MEC_SAA_Grenadier","MEC_SAA_ATSoldier","MEC_SAA_RPG7Soldier","MEC_SAA_AASoldier","MEC_SAA_Medic","MEC_SAA_Marksman","MEC_SAA_Crewman","MEC_SAA_Repair","MEC_SAA_Engineer","MEC_SAA_Explosives","MEC_SAA_Officer"];
...
if (INS_op_faction isEqualTo 8) then {// Middle Eastern Conflict - Hamas
	INS_Op4_side = EAST;
