...
_buzz = createVehicle ["B_Plane_CAS_01_F", _ranPos, [], 0, "FLY"];//"I_Plane_Fighter_03_CAS_F"
...
_pilot = _grp createUnit ["I_Pilot_F", _ranPos, [], 0, "FORM"];
...
(leader _grp) sideChat "Coordinates received, CAS inbound";
...
{
  (leader _grp) sideChat "Bombs dropped";
}
else
{
...
deleteMarker "CAS_TARGET";
(leader _grp) sideChat "CAS RTB 6 mikes.";
