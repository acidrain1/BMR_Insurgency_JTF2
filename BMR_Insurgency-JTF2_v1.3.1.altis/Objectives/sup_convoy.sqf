...
{_x addEventHandler ["killed", "(_this select 0) spawn {[_this] call remove_carcass_fnc}"]} forEach (units sconvoy_grp);
...
_tasktopicW = "Destroy Support Convoy";
_taskdescW = "Destroy support vehicle convoy of 4 and all crew members";
[_tskW,_tasktopicW,_taskdescW,WEST,[],"created",_newZone] call SHK_Taskmaster_add;
sleep 5;

// create east task
_tskE = "tskE_defend_convoy" + _rnum;
_tasktopicE = "Defend Support Convoy";
_taskdescE = "Defend support vehicle convoy of 4 and all crew members";
