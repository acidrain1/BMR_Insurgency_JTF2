class CfgSounds
{
	sounds[] = {NoSound,cantDo,Vent,Vent2,Para,shout,introfx,MagnusOpus,siren,HighVoltage,boo};
...
//Jig Sounds
	...
	class MagnusOpus {name="MagnusOpus";sound[]={"Sound\MagnusOpus.ogg", db-3, 1.0};titles[] = {};};
